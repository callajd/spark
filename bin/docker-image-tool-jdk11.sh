...
Options:
  ...
  -p file               (Currently Disabled) Dockerfile to build for PySpark Jobs. Builds Python dependencies and 
                        ships with Spark.  Skips building PySpark docker image if not specified.
  -R file               (Currently Disabled) Dockerfile to build for SparkR Jobs. Builds R dependencies and ships 
                        with Spark.  Skips building SparkR docker image if not specified.
...
Examples:
  ...
  - Build PySpark docker image (Currently Disabled)
